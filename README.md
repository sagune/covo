...
| 2026-05-05 | `configs/cb-whisper-shuili.yaml` | same fixed KWS checkpoint | Shuili low-threshold KWS candidate pool: `kws_positive_threshold=0.05`, `kws_topk_per_group=25`, `kws_max_prompt_keywords=100`, `rescore_max_keywords=50`; prompt still limited to 4 keywords | 0.8501 | 0.0841 | 0.1543 | 0.5069 | Accepted for Shuili. This confirms that the previous Shuili setting was too strict for the current KWS calibration: true-hotword threshold-only coverage at 0.30 was only 0.3712, while lowering the threshold and broadening the rescore pool lets CB-Whisper recover many useful candidates. Compared with the new-package baseline, Entity Recall improves by 0.0885, CER by 0.0158, Hotword Only CER by 0.0605, and WER by 0.0780. Oracle n-best summary: top1 recall 0.6193, oracle recall 0.6361, top1 hit rate 0.5059, oracle hit rate 0.5392. |
