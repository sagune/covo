...
This document defines the JSONL record shape shared by CB-SenseVoice exports,
rule baselines, teacher generation, and LoRA inference.
...
- `input.hotwords`: KWS/CB-SenseVoice hotword evidence.
