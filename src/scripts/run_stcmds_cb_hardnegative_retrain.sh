...
output_dir="${migration_root}/covo/outputs/qwen35_stcmds_cb_hardnegative_1epoch_20260728"
train_file="${source_data}/train.cb-hardnegative.qwen.jsonl"
messages="${workspace}/src/logs/stcmds_cb_sensevoice_targeted_chinesehp_messages_20260728.jsonl"
predictions="${workspace}/src/logs/stcmds_cb_sensevoice_targeted_chinesehp_hardnegative_predictions_full_20260728.jsonl"
metrics="${workspace}/src/logs/stcmds_cb_sensevoice_targeted_chinesehp_hardnegative_metrics_full_20260728.json"

"${python}" "${workspace}/src/analysis/build_stcmds_cb_hardnegative_sft.py" \
