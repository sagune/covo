...
def main():
    ...
    model = CBWhisper(
        ...
        oracle_nbest_detail_path="logs/oracle_nbest_detail_shuili_v3_tts_thr0942.csv",
        oracle_nbest_summary_path="logs/oracle_nbest_summary_shuili_v3_tts_thr0942.csv",
    )
    trainer = pl.Trainer(
        accelerator="gpu",
        devices=1,
